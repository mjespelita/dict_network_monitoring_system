...
@section('content')
    ...
    <div class='card'>
        ...
        <div class='form-group'>
            ...
            <input type='text' class='form-control' id='public_ip' name='public_ip' required>
        </div>
    
        <div class='form-group'>
            <label for='name'>Link_speed</label>
            <input type='text' class='form-control' id='link_speed' name='link_speed' required>
        </div>
    
        <div class='form-group'>
            <label for='name'>Duplex</label>
            <input type='text' class='form-control' id='duplex' name='duplex' required>
        </div>
