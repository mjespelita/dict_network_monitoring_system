                        ...
                        @forelse($incidents as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="nav-link" style="cursor: pointer" data-bs-toggle="modal" data-bs-target="#restoreOffline{{ $item->siteId }}"><i class='fas fa-recycle text-info'></i> Restore</a>
                                    ...
                                    <div class="modal fade" id="restoreOffline{{ $item->siteId }}" tabindex="-1" aria-labelledby="offlineSiteModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <div class="modal-header bg-danger text-white">
                                                <h5 class="modal-title" id="offlineSiteModalLabel">🚨 Site Offline - {{ $item->name }}</h5>
